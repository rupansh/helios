...
unsafe fn admit_mapping(
    ...
    match unsafe { submit_wddm_render(dev, queue, &ecl_submit_command(boundary), "TileMappings") } {
...
pub(super) unsafe extern "C" fn update_tile_mappings(
...
pub(super) unsafe extern "C" fn copy_tile_mappings(
    h_queue: ddi12::D3D12DDI_HCOMMANDQUEUE,
