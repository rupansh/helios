...
`docs/HELIOS_PRESENT_SYNC_RETIREMENT.md` (5918 lines, normative).
...
| §10.3 Resource identity | 1004–1179 | Only 1006–1091 (**D3D11**) and 1092–1110 (D3D12↔D3D11 open direction) bind this lane; 1111–1179 is the native-WSI lane. Defines the 168-byte `HeliosWddmAllocationDescV2` (HWA2) byte table (1033–1059), the `D3D12_RUNTIME_PRIMARY`/`DIRECT_FLIP_COMPATIBLE` rules (1061–1070), and the **inversion** of the current adoption direction (1072–1083). |
