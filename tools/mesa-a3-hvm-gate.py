...
def mutation_cases() -> tuple[Mutation, ...]:
    return (
        ...
        Mutation("accept opaque fence", MESA, "handle_type != VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE_BIT", "handle_type != VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_BIT"),
        ...
        Mutation("accept binary D3D12 fence", QUEUE, "sem->type != VK_SEMAPHORE_TYPE_TIMELINE ||\n       pImportSemaphoreWin32HandleInfo->handleType", "false ||\n       pImportSemaphoreWin32HandleInfo->handleType"),
