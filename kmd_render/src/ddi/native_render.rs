...
static NR2_COUNTERS: crate::diag::CounterBlock = crate::diag::CounterBlock {
    entries: &[
        ...
        e(b"Nr2PImpR2", &crate::ddi::create_allocation::IMP_PRIMARY_RID[2]),
        e(b"Nr2PImpR3", &crate::ddi::create_allocation::IMP_PRIMARY_RID[3]),
        e(b"Nr2PImpG0", &crate::ddi::create_allocation::IMP_PRIMARY_GEN[0]),
        e(b"Nr2PImpG1", &crate::ddi::create_allocation::IMP_PRIMARY_GEN[1]),
        ...
        e(BOUNDARY_NAMES[13], &crate::ddi::create_allocation::BS_SAMPLE_VA),
        f(BOUNDARY_NAMES[14], &crate::device::CONTEXT_HANDLE_REFUSED),
    ],
