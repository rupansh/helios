...
pub(crate) const SLOTS: [SlotAudit; SLOT_COUNT] = [
    ...
    SlotAudit {
        ...
        reason: "KMD display lane unit D3 (section 17.6:4465). NULL until the one-primary MPO3 validator lands.",
    },
    SlotAudit {
        ...
        min_version: "WDDM2_1",
        class: SlotClass::Pending,
        reason: "KMD display lane unit D3 (section 17.6:4466). NULL until the one-primary MPO3 binder lands.",
    },
    SlotAudit {
        ...
        min_version: "WDDM2_1",
        class: SlotClass::Pending,
        reason: "KMD display lane unit D3 (section 17.6:4497), an always-success bounded diagnostic callback with a named hit counter.",
    },
    SlotAudit {
        ...
        min_version: "WDDM2_1",
        class: SlotClass::Pending,
        reason: "KMD display lane unit D3 (section 17.6:4475).",
    },
    SlotAudit {
        ...
        min_version: "WDDM2_1",
        class: SlotClass::Pending,
        reason: "KMD display lane unit D3 (section 17.6:4478).",
    },
    SlotAudit {
    ...
    SlotAudit {
        ...
        min_version: "WDDM2_2",
        class: SlotClass::Pending,
        reason: "KMD display lane unit D3 (section 17.6:4473). NULL until the one-plane cap values land.",
    },
    SlotAudit {
        ...
        min_version: "WDDM2_2",
        class: SlotClass::Pending,
        reason: "KMD display lane unit D3 (section 17.6:4474). NULL until the no-post-transform cap values land.",
    },
    SlotAudit {
