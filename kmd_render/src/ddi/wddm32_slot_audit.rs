...
pub(crate) const SLOTS: [SlotAudit; SLOT_COUNT] = [
    ...
    SlotAudit {
        ...
        min_version: "WDDM2_0",
        class: SlotClass::Implemented,
        reason: "Segment 2 advertises SupportsCpuHostAperture; this populates its window.",
    },
    SlotAudit {
        ...
        min_version: "WDDM2_0",
        class: SlotClass::Implemented,
        reason: "Releases the blob mapping backing an aperture range dxgkrnl reclaims.",
    },
    SlotAudit {
