 ...
 * no_std Rust DDI bugchecks — the same trap seh_shim.c exists for, on a
 * different pointer.
 *
 ...
 *
 * Deliberately header-free, exactly as seh_shim.c is and for the same reason:
